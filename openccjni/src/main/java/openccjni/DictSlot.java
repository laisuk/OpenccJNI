 ...
 * {@link CustomDictSpec}.
 *
 * <p>Each value corresponds to one built-in dictionary. A custom dictionary
 * changes only its selected slot; other dictionaries in the conversion
 * pipeline remain available.</p>
 *
 * @see CustomDictMode
 * @see CustomDictSpec
 * @since 1.4.0
